...
Route::group(['middleware' => 'api.auth'], function () {
    ...
    Route::group(['prefix' => 'payments'], function () {
        ...
        Route::get('/verify/{gateway}', ['as' => 'api_payment_verify', 'uses' => 'PaymentsController@paymentVerify']);
        Route::post('/verify/{gateway}', ['as' => 'api_payment_verify_post', 'uses' => 'PaymentsController@paymentVerify']);
    });
    ...
    Route::group(['prefix' => 'my_assignments'], function () {
        ...
        Route::get('/{assignment}', ['uses' => 'AssignmentController@show'])->name('my_assignment.show');
