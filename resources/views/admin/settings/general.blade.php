...
=======
                                    <a class="nav-link @if(empty($social)) active @endif" id="basic-tab" data-toggle="tab"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="features-tab" data-toggle="tab" href="#features" role="tab"
                                        aria-controls="features" aria-selected="true">{{ trans('update.features') }}</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="reminders-tab" data-toggle="tab" href="#reminders" role="tab"
                                        aria-controls="reminders" aria-selected="true">{{ trans('update.reminders') }}</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="security-tab" data-toggle="tab" href="#security" role="tab"
                                        aria-controls="security" aria-selected="true">{{ trans('update.security') }}</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="general_options-tab" data-toggle="tab" href="#general_options"
                                        role="tab" aria-controls="general_options"
                                        aria-selected="true">{{ trans('update.options') }}</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="sms_channels-tab" data-toggle="tab" href="#sms_channels"
                                        role="tab" aria-controls="sms_channels"
                                        aria-selected="true">{{ trans('update.sms_channels') }}</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="ai_function-tab" data-toggle="tab" href="#ai_function"
                                        role="tab" aria-controls="ai_function"
                                        aria-selected="true">{{ trans('update.ai_function') }}</a>
>>>>>>> final_initial_branch
                                </li>
                            </ul>
...
=======
                                ...
                                @include('admin.settings.general.options', ['itemValue' => (!empty($settings) and !empty($settings['general_options'])) ? $settings['general_options']->value : ''])
                                @include('admin.settings.general.sms_channels', ['itemValue' => (!empty($settings) and !empty($settings['sms_channels'])) ? $settings['sms_channels']->value : ''])
                                @include('admin.settings.general.ai_function', ['itemValue' => (!empty($settings) and !empty($settings['ai_function'])) ? $settings['ai_function']->value : ''])
>>>>>>> final_initial_branch
                            </div>
