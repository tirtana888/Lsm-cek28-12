                ...
                <div class="mb-5">
                    ...
                    <div class="form-group custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <input type="checkbox" name="value[agora_for_events]" id="agoraForEventsSwitch" value="1" {{ (!empty($itemValue) and !empty($itemValue['agora_for_events']) and $itemValue['agora_for_events']) ? 'checked="checked"' : '' }} class="custom-switch-input"/>
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="agoraForEventsSwitch">{{ trans('update.agora_for_events') }}</label>
                        </label>
                 ...
                 <div class="mb-5">
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="freeModeSwitch">{{ trans('admin/main.active') }}</label>
                        </label>
