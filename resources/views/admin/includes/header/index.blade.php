...
=======
        {{-- About System --}}
        <div class="about-system-select position-relative">
            <div class="d-flex-center size-32 rounded-8 cursor-pointer position-relative"
                style="background-color: rgba(255, 255, 255, 0.2);">
                <x-iconsax-lin-info-circle class="icons text-white" width="20px" height="20px" />
            </div>

            <div class="about-system-dropdown py-12"
                style="position: absolute; top: 100%; right: 0; min-width: 340px; max-width: 380px; background: #fff; border-radius: 24px; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.15); border: 1px solid #e9ecef; opacity: 0; visibility: hidden; transform: translateY(15px); transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); z-index: 1050; top: 40px;">
>>>>>>> final_initial_branch
...
=======
                            <img src="{{ asset('assets/design_1/img/logo.jpg') }}" alt="Rocket LMS"
                                class="size-48 rounded-circle" style="object-fit: cover;">
>>>>>>> final_initial_branch
                        </div>
                        <div class="ml-12">
...
=======
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-8" style="gap: 8px;">
                            <a href="https://crm.rocket-soft.org/index.php/tickets" target="_blank"
                                class="badge badge-soft-primary font-10 px-8 py-4 text-decoration-none">Support
                                Center</a>
                            <a href="https://codecanyon.net/user/rocketsoft/portfolio" target="_blank"
                                class="badge badge-soft-primary font-10 px-8 py-4 text-decoration-none">Envato
                                Profile</a>
                            {{-- <a href="{{ getAdminPanelUrl('/licenses') }}"
                                class="badge badge-soft-primary font-10 px-8 py-4 text-decoration-none">License Info</a>
                            --}}
>>>>>>> final_initial_branch
                        </div>
                    </div>
...
=======
            <div class="js-show-ai-content-drawer d-flex-center size-32 rounded-8 cursor-pointer"
                style="background-color: rgba(255, 255, 255, 0.2);">
                <x-iconsax-lin-cpu-charge class="icons text-white" width="20px" height="20px" />
>>>>>>> final_initial_branch
            </div>
