@if(!empty($landingComponent) and $landingComponent->enable)
    ...
    @push('styles_top')
        <link rel="stylesheet" href="{{ getLandingComponentStylePath("hybrid_information_section_2_images_text_2") }}">
    @endpush

    <div class="hybrid-information-section-2-images-text-2-section position-relative">
        <div class="container position-relative h-100">
            <div class="row h-100 {{ (!empty($contents['reverse_direction']) and $contents['reverse_direction'] == "on") ? 'flex-row-reverse' : '' }} ">
                    ...
                    <div class="d-flex justify-content-center align-items-start flex-column h-100">
                        ...
                        <div class="d-flex align-items-center mt-60 gap-54">
                            @if(!empty($contents['statistic_1']))
                                <div class="hybrid-information-section-2-images-text-2-section__statistic-item">
                ...
                <div class="col-12 col-lg-6 h-100 mt-32 mt-lg-0 px-24 px-lg-48">
                    <div class="hybrid-information-section-2-images-text-2-section__main-image position-relative rounded-32">
                        @if(!empty($contents['image_content']))
                            ...
                            @if(!empty($contents['image_content']['overlay_image']))
                                <div class="hybrid-information-section-2-images-text-2-section__overlay-image">
