        ...
        <div class="col-12 col-lg-6 mt-16">
            <div class="bg-gray-100 p-16 rounded-16">
                <div class="">
                    ...
                    <p class="font-12 text-gray-500 mt-4">
                        {{ trans('update.drag_and_add_general_components_to_add_them_to_the_landing_page') }}</p>
                </div>
                ...
                <div class="form-group mb-0 mt-24">
                    ...
                    <select name="filter" class="js-filter-landing-builder-components form-control bg-gray-100">
                        ...
                        @foreach(\App\Enums\LandingBuilderComponentCategories::getAll() as $landingBuilderCategory)
                            <option value="{{ $landingBuilderCategory }}">{{ trans("update.{$landingBuilderCategory}") }}
                            </option>
                        @endforeach
                    </select>
                </div>
        ...
        <div class="col-12 col-lg-6 mt-16">
            <div class="bg-gray-100 p-16 rounded-16">
                <div class="">
                    ...
                    <p class="font-12 text-gray-500 mt-4">
                        {{ trans('update.sort_and_edit_different_components_you_added_to_the_page') }}</p>
                </div>
                ...
                @if(empty($landingItem->components) or !count($landingItem->components))
                    <div class="js-assigned-components-lists-no-items d-flex-center flex-column text-center py-120 px-48">
                        ...
                        <p class="font-12 text-gray-500 mt-4">
                            {{ trans('update.there_are_no_components_assigned_to_this_landing_page') }}</p>
                    </div>
                @endif

                {{-- Lists --}}
                <ul class="js-assigned-components-lists draggable-content-lists assigned-components-draggable-lists"
                    data-path="{{ getLandingBuilderUrl("/{$landingItem->id}/sort-components") }}"
                    data-drag-class="assigned-components-draggable-lists">
...
@else
    <div class="d-flex-center flex-column text-center py-56">
        ...
        <p class="text-gray-500 mt-8">
            {{ trans('update.you_need_to_save_the_landing_page_information_to_assign_components') }}</p>
    </div>
@endif