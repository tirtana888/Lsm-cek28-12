...
<body class="bg-gray {{ $isRtl ? 'rtl' : '' }} {{ "{$userThemeColorMode}-mode" }}">
    ...
    <div id="app">
        ...
        <div class="admin-auth-pages">
            ...
            <div
                class="admin-auth-pages__footer d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between bg-white px-24 py-14">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ml-8">
                        ...
                        <a href="https://codecanyon.net/user/rocketsoft/portfolio"
                            class="font-12 text-gray-500 mt-4">All rights reserved for Rocket Soft on Codecanyon</a>
                    </div>
                </div>
